...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.onChange = function (formData) {
      ...
      var state = {
        status: "editing",
        formData: formData,
        requiredSchema: (0, _utils.toRequiredSchema)(_this.props.schema, _this.state.requiredSchema, _this.props.uiSchema, _this.props.schema.definitions, formData, _this.props.formContext)
      };
      if (mustValidate) {
    ...
    _this.onBlur = function (path) {
      if ((0, _utils.deepGet)(path, _this.state.touchedSchema) !== true) {
        var state = (0, _utils.deepSet)(["touchedSchema"].concat(path), true, _this.state);
  ...
  _createClass(Form, [{
    ...
    value: function getStateFromProps(props) {
      ...
      var touchedSchema = state.touchedSchema || {};
      var requiredSchema = (0, _utils.toRequiredSchema)(schema, state.requiredSchema, uiSchema, definitions, formData, this.props.formContext);
      return {
        status: "initial",
        schema: schema,
        uiSchema: uiSchema,
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          touchedSchema = _state2.touchedSchema,
          requiredSchema = _state2.requiredSchema;
