...
var ObjectField = function (_Component) {
  ...
  function ObjectField(props) {
    ...
    _this.onPropertyBlur = function (name) {
      return function () {
        var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

        _this.props.onBlur([name].concat(path));
      };
    };
  ...
  _createClass(ObjectField, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          touchedSchema = _props.touchedSchema;
      ...
      return _react2.default.createElement(
        ...
        orderedProperties.map(function (name, index) {
          return _react2.default.createElement(SchemaField, { key: index,
            name: name,
            requiredSchema: _this3.props.requiredSchema[name],
            ...
            onBlur: _this3.onPropertyBlur(name),
            registry: _this3.props.registry,
            disabled: disabled,
            touchedSchema: (typeof touchedSchema === "undefined" ? "undefined" : _typeof(touchedSchema)) === "object" ? touchedSchema[name] : !!touchedSchema,
            readonly: readonly });
        })
      );
    }
...
if (process.env.NODE_ENV !== "production") {
  ObjectField.propTypes = {
    ...
    touchedSchema: _react.PropTypes.oneOfType([_react.PropTypes.object, _react.PropTypes.bool]),
