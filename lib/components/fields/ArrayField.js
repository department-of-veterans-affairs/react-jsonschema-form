...
var ArrayField = function (_Component) {
  ...
  function ArrayField(props) {
    ...
    _this.onItemBlur = function (index) {
      return function () {
        var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

        _this.props.onBlur([index].concat(path));
      };
    };
  ...
  _createClass(ArrayField, [{
    ...
    value: function renderNormalArray() {
      ...
      var _props2 = this.props,
          ...
          name = _props2.name,
          requiredSchema = _props2.requiredSchema,
          disabled = _props2.disabled,
          readonly = _props2.readonly,
          autofocus = _props2.autofocus,
          touchedSchema = _props2.touchedSchema;
        ...
        _react2.default.createElement(
          ...
          items.map(function (item, index) {
            ...
            return _this3.renderArrayFieldItem({
              ...
              itemTouched: (typeof touchedSchema === "undefined" ? "undefined" : _typeof(touchedSchema)) === "object" ? touchedSchema[index] : !!touchedSchema,
    ...
    value: function renderFixedArray() {
      ...
      var _props5 = this.props,
          ...
          name = _props5.name,
          requiredSchema = _props5.requiredSchema,
          disabled = _props5.disabled,
          readonly = _props5.readonly,
          autofocus = _props5.autofocus,
          touchedSchema = _props5.touchedSchema;
    ...
    value: function renderArrayFieldItem(_ref3) {
      var index = _ref3.index,
          ...
          itemTouched = _ref3.itemTouched,
          itemRequiredSchema = _ref3.itemRequiredSchema;
...
if (process.env.NODE_ENV !== "production") {
  ArrayField.propTypes = {
    ...
    requiredSchema: _react.PropTypes.object,
